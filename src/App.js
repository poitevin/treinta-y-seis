...
const App = () => {
  ...
  const spanishTranslations = [
    "Integral de cero a uno",
    "de integral de cero a e",
    "de raíz cuadrada de",
    "trescientos sesenta y uno",
    "de te de equis por uno",
    "sobre e por dieciséis",
    "menos ocho menos seis",
    "menos ciento diecisiete",
    "menos ciento treinta y siete",
    "es igual a treinta y seis."
  ];

  const linearEquation = "∫₀¹ ∫₀ᵉ √361 dt dx × 1 / e × 16 – 8 – 6 – 117 – 137 = 36";
    ...
    <div style={styles.container}>
      <div style={styles.wrapper}>
        ...
        <div style={styles.footer}>
          <p style={{marginBottom: '0.25rem'}}>Esta décima contiene exactamente 36 símbolos y su resultado es 36.</p>
